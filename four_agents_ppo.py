...
if __name__ == "__main__":
    ...
    G_profiles_4 = np.stack([
        discrete_random_state(T, start=100, low=50, high=150, step_choices=(-5, 0, 5),  seed=101),
        discrete_random_state(T, start=100, low=50, high=150, step_choices=(-10, -5, 0, 5, 10), seed=102),
        discrete_random_state(T, start=100, low=50, high=150, step_choices=(-5, 0, 5),  seed=103),
        discrete_random_state(T, start=100, low=50, high=150, step_choices=(-10, 0, 10), seed=104),
    ], axis=1)   # shape (T, 4)
    
    M = np.array([[0.7, 0.7, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3],
        [0.7, 0.7, 0.7, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3],
        [0.3, 0.7, 0.7, 0.7, 0.3, 0.3, 0.3, 0.3, 0.3],
        [0.3, 0.3, 0.7, 0.7, 0.7, 0.3, 0.3, 0.3, 0.3],
        [0.3, 0.3, 0.3, 0.7, 0.7, 0.3, 0.3, 0.3, 0.3],
        [0.7, 0.7, 0.3, 0.3, 0.3, 0.7, 0.3, 0.3, 0.3],
        [0.3, 0.7, 0.7, 0.3, 0.3, 0.3, 0.7, 0.3, 0.3],
        [0.3, 0.3, 0.7, 0.7, 0.3, 0.3, 0.3, 0.7, 0.3],
        [0.3, 0.3, 0.3, 0.7, 0.7, 0.3, 0.3, 0.3, 0.7],
        [0.7, 0.7, 0.3, 0.3, 0.3, 0.7, 0.3, 0.3, 0.3],
        [0.3, 0.7, 0.7, 0.3, 0.3, 0.3, 0.7, 0.3, 0.3],
        [0.3, 0.3, 0.7, 0.7, 0.3, 0.3, 0.3, 0.7, 0.3],
        [0.3, 0.3, 0.3, 0.7, 0.7, 0.3, 0.3, 0.3, 0.7]])
